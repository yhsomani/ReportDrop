-- ReportDrop Cloudflare D1 Database Schema
...
-- A given Razorpay payment may only ever finalize one subscription. This is the
-- durability guarantee behind idempotent verification: even a concurrent double
-- delivery of the same payment id cannot create two active subscriptions.
